...
//        System.out.println("-----amountParam"+amountParam);
        ...
        try {
            ...
            params.put("notifyUrl", "http://118.31.38.199:53020/notify/jeepaypay/notify_res.htm");   //支付结果后台回调URL
            ...
            String res = HttpUtil.post("http://118.31.38.199:53020/api/pay/create_order", genUrlParams(params));
